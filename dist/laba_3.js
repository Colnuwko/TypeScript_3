...
const dodg = new Car('Dodge', 'Challenger', '1974', '1HGCM82633A123456', 'У821НН');
...
dodg.owner = owner;
const ural = new Motorbike('Ural', 'М-62', '1965', 'JH2SC5900DK100264', 'ABC123');
const IW = new Motorbike('ИЖ', 'Лидер', '1989', 'JH2SC5900DK100264', 'СИВ472');
ural.owner = owner;
const kia = new Vehicle('киа', 'Рио', '2015', 'JH2SC5900DK100264', 'У821НН');
const hunday = new Vehicle('Хендай', 'Солярис', '2014', '2C4RDGBG5KR123789', 'A001ПР');
